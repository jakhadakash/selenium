...
class TestUntitled():
    ...
    def test_untitled(self):
        ...
        self.logger.info("Waiting for address suggestions to appear...")
        self.wait.until(EC.presence_of_element_located((
            By.XPATH,
            "//*[@id='gatsby-focus-wrapper']//button"
        )))
        self.logger.info("✓ Suggestions appeared")

        time.sleep(0.5)
        self.logger.info("Selecting first suggestion using arrow keys...")
        address_input.send_keys(Keys.ARROW_DOWN, Keys.ENTER)
        self.logger.info("✓ Address suggestion selected\n")
